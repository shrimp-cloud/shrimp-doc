...
- 下载
  ...
  - 下载 RocketMQ：wget https://dlcdn.apache.org/rocketmq/5.0.0/rocketmq-all-5.0.0-bin-release.zip
...
- 下载编译
  ...
  - 编译：mvn clean package -Dmaven.test.skip=true 【必需 jdk1.8, 已经测试 11,17不支持】
- 配置和启动
...
### 防火墙
```shell
# 端口说明：8080 控制台、8081 proxy、9876 NameServer、10909/10911/10912 Broker
# 开启
